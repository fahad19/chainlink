			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Subcommands: []cli.Command{
						{
							Name:   "create",
							Usage:  "Send <coins> from node Terra account <fromAddress> to destination <toAddress>, where coins is a comma separated list: <amount><denom>[,<amount><denom>]",
							Action: client.TerraSendCoins,
							Flags: []cli.Flag{
								cli.BoolFlag{
									Name:  "force",
									Usage: "allows to send a higher amount than the account's balance",
