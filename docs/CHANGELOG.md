...
- `LOG_FILE_MAX_SIZE` (default: 1024) - if `LOG_TO_DISK` is enabled, this env var allows you to override the log file's max size (in megabytes) before file rotation.
