...
- Added disk rotating logs and removed the `LOG_TO_DISK` ENV var.
...
- `LOG_FILE_DIR` (default: chainlink root directory) - this env var allows you to override the output directory for logging.
...
- `LOG_TO_DISK` - was removed in favor of disk rotating logs.
